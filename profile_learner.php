...
if (isset($_POST['add'])) {
   ...
   //  $mysqli = NEW  MySQLi('localhost', 'root', '' , 'praniti') ;
     ...
     $uid = $mysqli->real_escape_string($_POST['uid']);
      $lf = $mysqli->real_escape_string($_POST['learn_field']);
...
///////////////////////////////////////////////////////////////////
      ...
      $search = $mysqli->query("SELECT * FROM learner WHERE uid='$uid' ");
      if($search->num_rows!=0)
      {
      		$update = $mysqli->query("UPDATE learner SET course_taken='$lf' WHERE uid='$uid' ") ;
      }
      else{
     ...
     if(empty($lf) )
     {
        ...
        alert("Please fill all details");
 		window.location="profile_learner.php";
		</script> ';

     }
     else
     {
     		$query = $mysqli->query("INSERT INTO learner (uid, course_taken) VALUES ('$uid', '$lf') ");
      ...
      {
       echo '<script type="text/javascript">
       alert("success ! Learner Profile is Updated !");
       window.location="profile_learner.php";
...
<div class="logo_name" style="width: 550px ;">
  ...
  <div class="body">
		...
		<div class="login">
				...
				<label for="fields" style="color:blue;">Fields  To Learn:</label>
<br><br><br>				


<div ng-app="myApp" ng-controller="namesCtrl">

<input type="text" ng-model="test" list="fields" name="learn_field">
